...
![Подключение Power Query к PostgreSQL](dashboards/01_power_query_source.png)
...
* **Анализ смен:** Выявлен критический дисбаланс — **Смена 1 генерирует 46,7%** от общего объема брака (238 ед.). При этом Смена 2 работает в 2.4 раза чище, демонстрируя минимальный показатель в **19,2%**. Это сигнал для проверки компетенций линейных мастеров Смены 1.
